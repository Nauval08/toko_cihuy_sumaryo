document.addEventListener('DOMContentLoaded', () => {
  const produkPopulerContainer = document.getElementById('produk-populer');document.addEventListener('DOMContentLoaded', () => {
  ...
  const nomorWA = "6281234567890"; // Ganti nomor WhatsApp kamu tanpa tanda +
